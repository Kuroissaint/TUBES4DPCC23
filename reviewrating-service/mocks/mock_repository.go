...
import (
	...
	model "github.com/kuroissaint/tubes2dpcc/reviewrating-service/model"
)
...
func (m *MockReviewRepository) SaveReview(ctx context.Context, review model.Review) error {
	m.ctrl.T.Helper()
